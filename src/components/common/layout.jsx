          ...
          <ul className="space-y-2 font-medium">
            <li onClick={() => setTab("users")}>
              <a
                className={`${
                  tab == "users"
                    ? "flex items-center p-2 rounded-lg cursor-pointer dark:text-white dark:bg-gray-700 group"
              ...
              >
                <svg
                  className={` ${
                    tab == "users"
                      ? "flex-shrink-0 w-5 h-5 transition duration-75 dark:text-white "
