        ...
        > */}
          ...
          {/* <div className="bg-secondary rounded-3xl p-2 pl-8 text-xs mt-[5vh] md:rounded-[3vw] lg:rounded-[3vw] md:px-14 lg:px-14 md:p-8 lg:p-8 ml-2 md:ml-[2vw] lg:ml-[2vw]">
            <div className="flex flex-row w-[35vw] md:w-[20vw] lg:w-[20vw]">
              ...
              <a
                ...
                data-tooltip-html="The percentage of winning trades generated by the strategy."
          ...
          <div className="bg-secondary rounded-3xl p-2 pl-8 text-xs mt-[5vh] md:rounded-[3vw] lg:rounded-[3vw] md:px-14 lg:px-14 md:p-8 lg:p-8 ml-2 md:ml-[2vw] lg:ml-[2vw]">
            <div className="flex flex-row w-[35vw] md:w-[20vw] lg:w-[20vw]">
              ...
              <a
                data-tooltip-id="totalTrades"
                data-tooltip-html="The total number of closed trades (both winning and losing) generated by the strategy."
                className="w-6 h-6 ml-auto text-gray-800 md:w-12 lg:w-12 md:h-12 lg:h-12 dark:text-primary"
              >
                <svg
                  aria-hidden="true"
          ...
          <div className="bg-secondary rounded-3xl p-2 pl-8 text-xs mt-[5vh] md:rounded-[3vw] lg:rounded-[3vw] md:px-14 lg:px-14 md:p-8 lg:p-8 ml-2 md:ml-[2vw] lg:ml-[2vw]">
            <div className="flex flex-row w-[35vw] md:w-[20vw] lg:w-[20vw]">
              ...
              <a
                data-tooltip-id="winningTrades"
                data-tooltip-html="The total number of winning trades generated by the strategy."
                className="w-6 h-6 ml-auto text-gray-800 md:w-12 lg:w-12 md:h-12 lg:h-12 dark:text-primary"
              >
                <svg
                  aria-hidden="true"
          ...
          <div className="bg-secondary rounded-3xl p-2 pl-8 text-xs mt-[5vh] md:rounded-[3vw] lg:rounded-[3vw] md:px-14 lg:px-14 md:p-8 lg:p-8 ml-2 md:ml-[2vw] lg:ml-[2vw] md:mr-[2vw] lg:mr-[2vw]">
            <div className="flex flex-row w-[35vw] md:w-[20vw] lg:w-[20vw]">
              <p className="mt-1 font-poppins md:text-xl lg:text-xl">
                Losing Trades
              </p>
              <a
                data-tooltip-id="losingTrades"
                data-tooltip-html="The total number of losing trades generated by the strategy."
                className="w-6 h-6 ml-auto text-gray-800 md:w-12 lg:w-12 md:h-12 lg:h-12 dark:text-primary"
              >
                <svg
                  aria-hidden="true"
